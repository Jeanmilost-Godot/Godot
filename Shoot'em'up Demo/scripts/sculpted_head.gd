...
@onready var m_Head: Node3D = $Model
...
func _physics_process(delta):
	...
	# check the head collisions. Don't move it because the head is already moved by path
...
###
# Called when the head goes out of the screen
##
