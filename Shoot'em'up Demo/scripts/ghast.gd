...
@onready var m_Ghast: Node3D = $Model
...
func _physics_process(delta):
	...
	# check the ghast collisions. Don't move it because the ghast is already moved by path
...
###
# Called when the ghast goes out of the screen
##
